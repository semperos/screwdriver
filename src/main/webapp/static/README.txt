...
To access a local endpoint, hit http://localhost:8000/local - this will show a simple JSP page.
To access a local servlet, hit http://localhost:8000/local/servlet, which displays the value of the
'action' parameter, if one is passed as part of the query (e.g. /local/servlet?action=doStuff)
